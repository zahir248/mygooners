...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-900">{{ __('Butiran Permohonan Penjual') }}</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <div class="p-6">
                    <div class="flex items-center mb-6">
                        ...
                        <div class="ml-6">
                            ...
                            <p class="text-gray-500">{{ $seller->phone ?? 'Tiada' }}</p>
                            <div class="mt-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Lokasi') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->location ?? 'Tiada' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Bio') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->bio ?? 'Tiada' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Tarikh Daftar') }}</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Status Pengesahan') }}</label>
                            <p class="mt-1 text-sm text-gray-900">
                                @if($seller->is_verified)
                                    <span class="text-green-600">{{ __('Disahkan') }}</span>
                                @else
                                    <span class="text-gray-600">{{ __('Belum Disahkan') }}</span>
                                @endif
                            </p>
                        </div>
                    </div>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Maklumat Perniagaan') }}</h3>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Nama Perniagaan') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->business_name ?? 'Tiada' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Jenis Perniagaan') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->business_type ?? 'Tiada' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Pendaftaran Perniagaan') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->business_registration ?? 'Tiada' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Alamat Perniagaan') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->business_address ?? 'Tiada' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Kawasan Operasi') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->operating_area ?? 'Tiada' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Laman Web') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->website ?? 'Tiada' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Tahun Pengalaman') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->years_experience ?? 'Tiada' }} tahun</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">{{ __('Kemahiran') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->skills ?? 'Tiada' }}</p>
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700">{{ __('Kawasan Perkhidmatan') }}</label>
                            <p class="mt-1 text-sm text-gray-900">{{ $seller->service_areas ?? 'Tiada' }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Dokumen') }}</h3>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Dokumen Pengenalan') }}</label>
                            ...
                            @else
                                <p class="text-sm text-gray-500">{{ __('Tiada dokumen') }}</p>
                            @endif
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Selfie dengan ID') }}</label>
                            ...
                            @else
                                <p class="text-sm text-gray-500">{{ __('Tiada gambar') }}</p>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Sebab Penolakan') }}</h3>
                </div>
                <div class="p-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Status Permohonan') }}</h3>
                </div>
                <div class="p-6">
                    <div class="text-center">
                        @if($seller->seller_status === 'pending')
                            ...
                            <h4 class="mt-4 text-lg font-medium text-gray-900">{{ __('Menunggu') }}</h4>
                            <p class="mt-2 text-sm text-gray-500">{{ __('Permohonan sedang menunggu kelulusan') }}</p>
                        @elseif($seller->seller_status === 'approved')
                            ...
                            <h4 class="mt-4 text-lg font-medium text-gray-900">{{ __('Diluluskan') }}</h4>
                            <p class="mt-2 text-sm text-gray-500">{{ __('Permohonan telah diluluskan') }}</p>
                        @elseif($seller->seller_status === 'rejected')
                            ...
                            <h4 class="mt-4 text-lg font-medium text-gray-900">{{ __('Ditolak') }}</h4>
                            <p class="mt-2 text-sm text-gray-500">{{ __('Permohonan telah ditolak') }}</p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Tindakan Berbahaya') }}</h3>
                </div>
                <div class="p-6">
                    <button type="button" 
...
<div id="rejectModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900 mt-4">{{ __('Tolak Permohonan Penjual') }}</h3>
            <div class="mt-2 px-7 py-3">
                ...
                <form method="POST" action="{{ route('admin.seller-requests.reject', $seller->id) }}">
                    @csrf
                    <div class="mb-4">
                        <label for="seller_rejection_reason" class="block text-sm font-medium text-gray-700 text-left">{{ __('Sebab Penolakan') }}</label>
                        <textarea name="seller_rejection_reason" id="seller_rejection_reason" rows="3" required
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                  placeholder="{{ __('Sila berikan sebab penolakan...') }}"></textarea>
                    </div>
                    <button type="submit" 
...
<div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900 mt-4">{{ __('Padam Permohonan Penjual') }}</h3>
            <div class="mt-2 px-7 py-3">
                <p class="text-sm text-gray-500">
