...
@section('title', __('Statistik Ulasan Perkhidmatan'))
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">{{ __('Statistik Ulasan Perkhidmatan') }}</h1>
            <p class="mt-2 text-sm text-gray-700">{{ __('Analisis mendalam prestasi perkhidmatan berdasarkan ulasan pelanggan') }}</p>
        </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">{{ __('Perkhidmatan Direview') }}</p>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">{{ __('Perkhidmatan Terbaik') }}</p>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Analisis Perkhidmatan') }}</h3>
                </div>
            </div>
                ...
                @if($stats['total_reviews'] > 0)
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-700">{{ __('Liputan Perkhidmatan') }}</span>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-700">{{ __('Perkhidmatan Berkualiti Tinggi') }}</span>
                            </div>
                    ...
                    <div class="mt-6 p-4 bg-gray-50 rounded-lg border-l-4 border-blue-500">
                        <p class="text-sm text-gray-700 leading-relaxed">
                            ...
                            {{ __('Portfolio perkhidmatan menunjukkan prestasi yang memberangsangkan dengan :rating bintang purata. :count perkhidmatan mendapat pengiktirafan tinggi, mencerminkan komitmen terhadap kualiti dan kepuasan pelanggan.', [
                                'rating' => number_format($stats['average_rating'], 1),
                                'count' => number_format($stats['top_rated_services'] ?? 0),
                            ]) }}
                        </p>
                    </div>
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="text-sm text-gray-500">{{ __('Belum ada perkhidmatan yang telah direview oleh pelanggan.') }}</p>
                    </div>
                @endif
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <a href="{{ route('admin.services.index') }}" 
                   class="bg-green-100 hover:bg-green-200 text-green-800 px-4 py-3 rounded-lg text-center transition-colors">
                    ...
                    <div class="text-sm">{{ __('Semua Perkhidmatan') }}</div>
                </a>
