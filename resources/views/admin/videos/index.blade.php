...
@section('title', __('Pengurusan Video'))
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">{{ __('Pengurusan Video') }}</h1>
            <p class="mt-2 text-sm text-gray-700">{{ __('Urus semua video Arsenal dan kandungan multimedia') }}</p>
        </div>
...
<div class="mx-4 bg-white shadow rounded-lg mb-6">
    <form method="GET" action="{{ route('admin.videos.index') }}" class="px-6 py-4 border-b border-gray-200">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <h3 class="text-lg font-medium text-gray-900 mb-4 sm:mb-0">{{ __('Tapis Video') }}</h3>
...
<div class="mx-4 bg-white shadow overflow-hidden sm:rounded-lg">
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <h3 class="text-lg font-medium text-gray-900">
                {{ trans('admin_page.list_videos', ['count' => $videos->count()]) }}
            </h3>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('Video') }}</th>
                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm text-gray-500 line-clamp-2">
                                            {{ trans('admin_page.list_video_meta', ['id' => $video->id, 'youtube_id' => $video->youtube_video_id]) }}
                                        </p>
                                        <p class="text-sm text-gray-500 line-clamp-2">
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900">{{ __('Tiada video') }}</h3>
            <p class="mt-1 text-sm text-gray-500">{{ __('Mula menambah video untuk komuniti MyGooners.') }}</p>
            <div class="mt-6">
                <a href="{{ route('admin.videos.create') }}" 
...
<div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden" style="z-index: 50;">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900 mt-4">{{ __('Padam Video') }}</h3>
