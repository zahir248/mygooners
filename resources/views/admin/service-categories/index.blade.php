...
@section('title', __('Kategori Perkhidmatan'))
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">{{ __('Kategori Perkhidmatan') }}</h1>
            <p class="mt-2 text-sm text-gray-700">{{ __('Urus kategori untuk perkhidmatan komuniti') }}</p>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('Kunci') }}</th>
