...
@section('title', 'Kategori Perkhidmatan')
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Kategori Perkhidmatan</h1>
            <p class="mt-2 text-sm text-gray-700">Urus kategori untuk perkhidmatan komuniti</p>
        </div>
...
<div class="mx-4 bg-white shadow rounded-lg mb-6">
    <form method="GET" action="{{ route('admin.service-categories.index') }}" class="px-6 py-4 border-b border-gray-200">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <h3 class="text-lg font-medium text-gray-900 mb-4 sm:mb-0">Tapis Kategori</h3>
...
<div class="mx-4 bg-white shadow overflow-hidden sm:rounded-lg">
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900">Tiada kategori</h3>
            <p class="mt-1 text-sm text-gray-500">
                @if(request('search') || request('status'))
                    Tiada kategori sepadan dengan tapisan anda.
                @else
                    Mulakan dengan menambah Kategori Perkhidmatan pertama anda.
                @endif
            </p>
            <div class="mt-6">
                @if(request('search') || request('status'))
