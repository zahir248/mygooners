...
@section('title', __('Tambah Kategori Perkhidmatan'))
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">{{ __('Tambah Kategori Perkhidmatan') }}</h1>
    </div>
        ...
        <form action="{{ route('admin.service-categories.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required
                       placeholder="{{ __('Contoh: Coaching, Transport') }}"
                ...
                <p class="mt-1 text-sm text-gray-500">{{ __('Nilai ini disimpan dalam pangkalan data perkhidmatan.') }}</p>
                @error('name')
            ...
            <div>
                ...
                <input type="text" name="label" id="label" value="{{ old('label') }}" required
                       placeholder="{{ __('Contoh: Pengangkutan, Katering') }}"
            ...
            <div class="flex items-center">
                ...
                <label for="is_active" class="ml-2 block text-sm text-gray-900">{{ __('Aktif (boleh dipilih semasa cipta perkhidmatan)') }}</label>
            </div>
