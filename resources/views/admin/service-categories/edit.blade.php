...
@section('title', __('Sunting Kategori Perkhidmatan'))
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">{{ __('Sunting Kategori Perkhidmatan') }}</h1>
    </div>
    ...
    <div class="max-w-xl bg-white shadow rounded-lg p-6">
        <form action="{{ route('admin.service-categories.update', $serviceCategory) }}" method="POST" class="space-y-6">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('admin.service-categories.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 text-sm font-medium">{{ __('Batal') }}</a>
            </div>
        </form>
    </div>
</div>
