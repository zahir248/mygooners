...
@section('title', __('Tambah Kategori Video'))
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">{{ __('Tambah Kategori Video') }}</h1>
    </div>
    ...
    <div class="max-w-xl bg-white shadow rounded-lg p-6">
        <form action="{{ route('admin.video-categories.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex items-center">
                ...
                <label for="is_active" class="ml-2 block text-sm text-gray-900">{{ __('Aktif (boleh dipilih semasa cipta video)') }}</label>
            </div>
