...
@section('title', __('Kategori Video'))
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">{{ __('Kategori Video') }}</h1>
            <p class="mt-2 text-sm text-gray-700">{{ __('Urus kategori untuk video berita dan blog') }}</p>
        </div>
...
<div class="mx-4 bg-white shadow rounded-lg mb-6">
    <form method="GET" action="{{ route('admin.video-categories.index') }}" class="px-6 py-4 border-b border-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center space-x-2 justify-end">
                                    ...
                                    <form action="{{ route('admin.video-categories.destroy', $category) }}" method="POST" class="inline"
    ...
    @else
        <div class="text-center py-12">
            ...
            <p class="mt-1 text-sm text-gray-500">
                ...
                @else
                    Mulakan dengan menambah Kategori Video pertama anda.
                @endif
            </p>
            <div class="mt-6">
                @if(request('search') || request('status'))
