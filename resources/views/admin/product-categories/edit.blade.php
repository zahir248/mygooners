...
@section('title', __('Sunting Kategori Produk'))
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">{{ __('Sunting Kategori Produk') }}</h1>
    </div>
    ...
    <div class="max-w-xl bg-white shadow rounded-lg p-6">
        <form action="{{ route('admin.product-categories.update', $productCategory) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">{{ __('Slug dikemas kini secara automatik apabila kunci sistem ditukar.') }}</p>
            </div>
