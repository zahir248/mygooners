...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">{{ __('Kategori Produk') }}</h1>
            <p class="mt-2 text-sm text-gray-700">{{ __('Urus kategori untuk produk kedai') }}</p>
        </div>
...
<div class="mx-4 bg-white shadow rounded-lg mb-6">
    <form method="GET" action="{{ route('admin.product-categories.index') }}" class="px-6 py-4 border-b border-gray-200">
    ...
    @else
        <div class="text-center py-12">
            ...
            <p class="mt-1 text-sm text-gray-500">
                ...
                @else
                    Mulakan dengan menambah Kategori Produk pertama anda.
                @endif
            </p>
            <div class="mt-6">
                @if(request('search') || request('status'))
