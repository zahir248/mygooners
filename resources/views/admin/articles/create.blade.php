            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="twitter_embed" 
                              ...
                              placeholder="Paste Twitter embed code here...">{{ old('twitter_embed') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="facebook_embed" 
                              ...
                              placeholder="Paste Facebook embed code here...">{{ old('facebook_embed') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="instagram_embed" 
                              ...
                              placeholder="Paste Instagram embed code here...">{{ old('instagram_embed') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="tiktok_embed" 
                              ...
                              placeholder="Paste TikTok embed code here...">{{ old('tiktok_embed') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="custom_embed" 
                              ...
                              placeholder="Paste any custom embed code here...">{{ old('custom_embed') }}</textarea>
