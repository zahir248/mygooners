...
@section('title', __('Cipta Artikel'))
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">{{ __('Cipta Artikel Baharu') }}</h1>
            <p class="mt-2 text-sm text-gray-700">{{ __('Tulis dan terbitkan artikel Arsenal baharu') }}</p>
        </div>
        ...
        <div class="px-6 py-4 space-y-6">
            ...
            <div>
                ...
                <textarea name="excerpt" 
                          ...
                          placeholder="{{ __('Ringkasan ringkas artikel (maksimum 500 aksara)') }}">{{ old('excerpt') }}</textarea>
            ...
            <div>
                ...
                <textarea name="content" 
                          ...
                          placeholder="{{ __('Tulis kandungan artikel anda di sini...') }}">{{ old('content') }}</textarea>
                @error('content')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <div id="image-preview" class="mt-4 hidden">
                    <p class="text-sm font-medium text-gray-700 mb-2">{{ __('Pratonton Imej:') }}</p>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="twitter_embed" 
                              ...
                              placeholder="{{ __('Paste Twitter embed code here...') }}">{{ old('twitter_embed') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="facebook_embed" 
                              ...
                              placeholder="{{ __('Paste Facebook embed code here...') }}">{{ old('facebook_embed') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="instagram_embed" 
                              ...
                              placeholder="{{ __('Paste Instagram embed code here...') }}">{{ old('instagram_embed') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="tiktok_embed" 
                              ...
                              placeholder="{{ __('Paste TikTok embed code here...') }}">{{ old('tiktok_embed') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="custom_embed" 
                              ...
                              placeholder="{{ __('Paste any custom embed code here...') }}">{{ old('custom_embed') }}</textarea>
        ...
        <div class="px-6 py-4 space-y-6">
            ...
            <div>
                ...
                <textarea name="meta_description" 
                          ...
                          placeholder="{{ __('Deskripsi SEO tersuai (lalai kepada ringkasan artikel)') }}">{{ old('meta_description') }}</textarea>
