...
@section('title', 'Pengurusan Ulasan Produk')
...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Pengurusan Ulasan Produk</h1>
            <p class="mt-2 text-sm text-gray-700">Urus semua ulasan produk Arsenal yang diterima</p>
        </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm text-gray-500 line-clamp-2">
                                            ID Produk: #{{ $review->product->id }} • {{ $review->product->category }}
                                        </p>
                                    </div>
                                </div>
                            </td>
