...
@section('title', __('Butiran Pengguna'))
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500">{{ __('Peranan') }}</dt>
                                        <dd class="mt-1">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500">{{ __('Log Masuk Terakhir') }}</dt>
                                        <dd class="mt-1 text-sm text-gray-900">{{ $user->last_login?->format('j M Y \p\a\d\a g:i A') ?? 'Tidak pernah' }}</dd>
                                    </div>
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500">{{ __('Ahli Sejak') }}</dt>
                    ...
                    <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-200">
                            <h3 class="text-lg font-medium text-gray-900">{{ __('Statistik Aktiviti') }}</h3>
                        </div>
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-red-600">{{ $user->articles_count ?? 0 }}</div>
                                    <div class="text-sm text-gray-500">{{ __('Artikel Diterbitkan') }}</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-blue-600">{{ $user->services_count ?? 0 }}</div>
                                    <div class="text-sm text-gray-500">{{ __('Perkhidmatan Aktif') }}</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-green-600">{{ $user->reviews_count ?? 0 }}</div>
                                    <div class="text-sm text-gray-500">{{ __('Ulasan Diberikan') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="space-y-3">
                                ...
                                @empty
                                    <div class="text-center text-gray-500 py-6">
                                        ...
                                        <p class="mt-2 text-sm">{{ __('Tiada aktiviti terkini') }}</p>
                                    </div>
                                @endforelse
                            </div>
                        </div>
