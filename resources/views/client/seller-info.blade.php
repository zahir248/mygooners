...
<div x-data="{ showIdModal: false, showSelfieModal: false, showProfileModal: false }" x-effect="document.body.classList.toggle('overflow-hidden', showProfileModal)" class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Maklumat Penjual</h1>
                <p class="text-gray-600">Maklumat lengkap perniagaan dan dokumen pengesahan anda</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-gray-900 font-medium">{{ $user->business_name }}</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Jenis Perniagaan</label>
                    <p class="text-gray-900">{{ $user->business_type }}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-gray-900">{{ $user->business_address }}</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Kawasan Operasi</label>
                    <p class="text-gray-900">{{ $user->operating_area }}</p>
                </div>
                <div>
            ...
            @if($user->id_document)
                <div class="border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center justify-between mb-3">
                        <h4 class="font-semibold text-gray-900">Dokumen ID</h4>
