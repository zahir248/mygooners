            ...
            <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-orange-800 space-y-2">
                                        <p>• <strong>Maklumat Bank:</strong> Sila berikan maklumat bank anda untuk pemprosesan refund</p>
                                        <p>• <strong>Maklumat Tracking:</strong> Sila berikan nombor tracking dan syarikat penghantaran</p>
                                        <p>• <strong>Masa Pengisian:</strong> Maklumat ini boleh diisi <strong>SELEPAS</strong> anda menghantar item balik</p>
                                        <p>• <strong>Proses Refund:</strong> Refund akan diproses <strong>SELEPAS</strong> item tiba dengan selamat di pihak kami</p>
                                        <p>• <strong>Masa Pemprosesan:</strong> Refund akan diproses dalam masa 3-5 hari bekerja selepas item diterima</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="flex items-start space-x-3">
                             ...
                             <div>
                                 ...
                                 <div class="text-purple-800 space-y-2">
                                     <p>✅ <strong>Maklumat Lengkap:</strong> Semua maklumat bank dan tracking telah diterima</p>
                                     <p>⏳ <strong>Status Semasa:</strong> Refund sedang diproses oleh pihak kami</p>
                                     <p>⏰ <strong>Masa Pemprosesan:</strong> Refund akan diproses dalam masa 3-5 hari bekerja</p>
                                     <p>📧 <strong>Notifikasi:</strong> Anda akan dimaklumkan melalui email apabila refund selesai diproses</p>
                                 </div>
                             </div>
                         </div>
                     </div>
                ...
                @endif
                 ...
                 @if($refund->receipt_image)
                     <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                         <h3 class="text-lg font-semibold text-green-900 mb-4">✅ Resit Transaksi Refund</h3>
                         <div class="text-center">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <div class="space-y-2 text-sm text-blue-800">
                        <p>📧 Email: support@mygooners.com</p>
                        <p>📞 Telefon: +60 12-345 6789</p>
                        <p>⏰ Masa: Isnin - Jumaat, 9:00 AM - 6:00 PM</p>
                    </div>
                </div>
            </div>
        </div>
