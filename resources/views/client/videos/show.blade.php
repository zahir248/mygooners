...
@section('title', $video->title . __('videos_page.title_suffix'))
            ...
            <ol class="flex items-center space-x-4">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('videos.index') }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">{{ __('Video') }}</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
    ...
    <div class="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-6 pb-6 border-b border-gray-200">
                        <div class="flex items-center space-x-6 text-sm text-gray-500">
                            ...
                            <div class="flex items-center">
                                ...
                                {{ number_format($video->views_count) }} {{ __('tontonan') }}
                            </div>
                        </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <h3 class="text-sm font-medium text-gray-900 mb-4">{{ __('Label') }}</h3>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <h3 class="text-sm font-medium text-gray-900 mb-4">{{ __('Kongsi video ini') }}</h3>
        ...
        <div class="lg:col-span-1 mt-8 lg:mt-0">
            ...
            @if($relatedVideos->count() > 0)
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="p-4 border-b border-gray-200">
                        <h3 class="text-lg font-bold text-gray-900">{{ __('Related Videos') }}</h3>
                    </div>
                            ...
                            @endif
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex items-center text-xs text-gray-500 mt-1">
                                                <span>{{ __('videos_page.views_count', ['count' => number_format($relatedVideo->views_count)]) }}</span>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden mt-6">
                <div class="p-4 border-b border-gray-200">
                    <h3 class="text-lg font-bold text-gray-900">{{ __('Video Categories') }}</h3>
                </div>
                <div class="p-4">
                    <div class="space-y-2">
                        <a href="{{ route('videos.index') }}" 
                           class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-red-600 rounded transition-colors">{{ __('All Videos') }}</a>
