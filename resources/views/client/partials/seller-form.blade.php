<form method="POST" action="{{ route('dashboard.become_seller') }}" enctype="multipart/form-data" class="w-full bg-white p-6 rounded-lg shadow-md space-y-4">
    @csrf
    ...
    <button type="submit" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-medium">Hantar Permohonan</button>
</form> 