                        ...
                        @foreach($cart->items as $item)
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="text-right">
                                    @php
                                        $originalPrice = $item->variation ? $item->variation->price : $item->product->price;
                                        $finalPrice = $item->price; // This is already the sale price if available
